...
var min = Math.min;
var round = Math.round;function getUAString() {
  ...
  setup: function setup(__props, _ref) {
    ...
    vue.onMounted(function () {
      ...
      if (children && children.filter(function (child) {
        return (child === null || child === void 0 ? void 0 : child.tag) !== undefined;
      }).length > 1) {
...
styleInject(css_248z);script.__scopeId = "data-v-4fac52f2";// Default export is installable instance of component.
